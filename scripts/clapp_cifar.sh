...
python -m vision.train_ssl --save_dir clapp_cifar --dataset cifar10 --data_input_dir $cifar_root --num_epochs 300 --asymmetric_W_pred --customize_loss_pool 4-4-4-2-2-1
...
python -m vision.train_ssl --save_dir clapp_dfb_cifar --dataset cifar10 --data_input_dir $cifar_root --num_epochs 300 --asymmetric_W_pred --customize_loss_pool 4-4-4-2-2-1 --customize_fb_idx 6-6-6-6-6-6
...
python -m vision.train_ssl --save_dir clapp_both_cifar --dataset cifar10 --data_input_dir $cifar_root --num_epochs 300 --asymmetric_W_pred --customize_loss_pool 4-4-4-2-2-1 --customize_fb_idx 6-6-6-6-6-6 --extra_lateral_loss
